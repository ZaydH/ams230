...
%---------------------------------------------------%
%  Commands for the Structure of New Problem Files  %
%---------------------------------------------------%
...
%  \FloatBarrier  % Prevent preceding floats going to this page
%  \newpage
%  \vspace*{\fill}
%  \centering
%  \textbf{\Huge Python Source Code \\~\\ for Exercise~\#\ref{prob:02}}
%  \vspace*{\fill}
\end{document}
