...
\begin{proof}
  ...
  \begin{aligncustom}
    m(\tilde{p}(\tau)) &= \tau g\transpose p^{U} + \frac{\tau^{2}}{2} \left(p^{U}\right)\transpose B p^{U} \\
                       &= \tau g\transpose p^{U} - \frac{\tau^2}{2} \left(p^{U} \right)\transpose g \\
                       &= g\transpose p^{U} \left(\tau - \frac{\tau^2}{2} \right) \\
                       &= -\frac{\norm{g}^2 g\transpose g}{g\transpose B g}\left(\tau - \frac{\tau^2}{2}\right) \\
                       &= \frac{\left(\norm{g}^2\right)^2}{g\transpose B g}\left(-\tau + \frac{\tau^2}{2}\right) \\
  \end{aligncustom}
